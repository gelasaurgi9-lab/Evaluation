...
const InstractorResultInMyDepartment = () => {
    ...
    // Get instructors from the college dean's department
    ...
    return (
        <div className="p-6 bg-(--one)">
            <Card >
                <CardHeader>
                    <CardTitle className='py-10'>
                        Instructors in {user?.department || 'Your Department'}
                    </CardTitle>
                    <CardDescription>
                        Click on an instructor's name to view their detailed evaluation results
                    </CardDescription>
                </CardHeader>
                <CardContent >
                    <Table >
...
export default InstractorResultInMyDepartment;