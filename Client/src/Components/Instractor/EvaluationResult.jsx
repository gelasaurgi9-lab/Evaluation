...
const EvaluationResult = () => {
  ...
  return (
    <div className='mb-20'>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '15px', marginBottom: '20px' }}>
          ...
          {supervisorAverage && (
            <div style={{
              ...
              <h3 style={{ color: '#d4e6d5ff', margin: '0 0 10px 0' }}>Supervisor  Evaluations</h3>
              <div style={{ fontSize: '20px', fontWeight: 'bold', color: '#cae7ccff' }}>
          ...
          {selfAverage && (
            <div style={{
              ...
              <h3 style={{ color: '#d4e6d5ff', margin: '0 0 10px 0' }}>Self Evaluations</h3>
              <div style={{ fontSize: '20px', fontWeight: 'bold', color: '#cae7ccff' }}>
          ...
          {staffAverage && (
            <div style={{
              ...
              <h3 style={{ color: '#d4e6d5ff', margin: '0 0 10px 0' }}>Staff Evaluations</h3>
              <div style={{ fontSize: '20px', fontWeight: 'bold', color: '#cae7ccff' }}>
      ...
      <DownlodResult responses={responses} user={user} />
    </div>
  )
}
