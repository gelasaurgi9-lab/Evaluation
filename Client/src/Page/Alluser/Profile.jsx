            ...
            <div className="mt-4 sm:mt-0">
              ...
              <div className="mt-4 flex flex-wrap gap-4">
                <div className="flex items-center text-sm text-gray-300">
                  <FaEnvelope className="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-100" />
                  {userData.email}
                </div>
          ...
          <div className="border-b border-gray-200">
            <nav className="-mb-px flex space-x-8">
              <button
                ...
                className={`cursor-pointer ${activeTab === 'about' ? 'border-green-500 text-green-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm`}
              >
                <FaUser className="inline mr-2" /> About
              </button>
              <button
                onClick={() => setActiveTab('courses')}
                className={`cursor-pointer ${activeTab === 'courses' ? 'border-green-500 text-green-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm`}
              >
                <Key className="inline mr-2" /> Security
              </button>
             
              <button
                onClick={() => setActiveTab('settings')}
                className={`cursor-pointer ${activeTab === 'settings' ? 'border-green-500 text-green-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm`}
              >
          ...
          <div className="mt-6">
            ...
            {activeTab === 'courses' && (
              <div className="bg-white shadow overflow-hidden sm:rounded-lg p-6">
                <h3 className="text-lg font-medium text-gray-900 p-3">Change My Password</h3>
               <Security/>
              </div>
            )}
